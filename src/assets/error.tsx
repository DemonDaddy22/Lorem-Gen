...
const ErrorImage = (props: Props) => {
    const { height, width, baseColorPrimary, baseColorSecondary, colorPrimary, colorSecondary } = props;
    ...
    return (
        ...
        >
            ...
            <path
                ...
                opacity='0.2'
            />
            <ellipse cx='198.60911' cy='424.5' rx='187' ry='25.43993' fill={colorSecondary} />
            <ellipse cx='198.60911' cy='424.5' rx='157' ry='21.35866' opacity='0.1' />
            <ellipse cx='836.60911' cy='660.5' rx='283' ry='38.5' fill={colorSecondary} />
            <ellipse cx='310.60911' cy='645.5' rx='170' ry='23.12721' fill={colorSecondary} />
            <path
            ...
            <rect
                ...
                fill={baseColorPrimary}
            />
            <rect x='595.70294' y='231.77652' width='478.71308' height='267.83694' fill={colorSecondary} />
            <circle cx='835.05948' cy='223.29299' r='3.02983' fill={baseColorSecondary} />
            <path
            ...
            <path
                ...
                opacity='0.1'
            />
            <ellipse cx='1066.53846' cy='654.13477' rx='7.87756' ry='2.42386' fill={baseColorSecondary} />
            <circle cx='835.05948' cy='545.66686' r='11.51335' fill={baseColorSecondary} />
            <polygon
                points='968.978 667.466 968.978 673.526 642.968 673.526 642.968 668.678 643.417 667.466 968.978 667.466'
                opacity='0.1'
            />
            <rect x='108.60911' y='159' width='208' height='242' fill={baseColorPrimary} />
            <rect x='87.60911' y='135' width='250' height='86' fill={colorSecondary} />
            <rect x='87.60911' y='237' width='250' height='86' fill={colorSecondary} />
            <rect x='87.60911' y='339' width='250' height='86' fill={colorSecondary} />
            <rect x='271.60911' y='150' width='16' height='16' fill={colorPrimary} opacity='0.4' />
            <rect x='294.60911' y='150' width='16' height='16' fill={colorPrimary} opacity='0.8' />
            <rect x='317.60911' y='150' width='16' height='16' fill={colorPrimary} />
            <rect x='271.60911' y='251' width='16' height='16' fill={colorPrimary} opacity='0.4' />
            <rect x='294.60911' y='251' width='16' height='16' fill={colorPrimary} opacity='0.8' />
            <rect x='317.60911' y='251' width='16' height='16' fill={colorPrimary} />
            <rect x='271.60911' y='352' width='16' height='16' fill={colorPrimary} opacity='0.4' />
            <rect x='294.60911' y='352' width='16' height='16' fill={colorPrimary} opacity='0.8' />
            <rect x='317.60911' y='352' width='16' height='16' fill={colorPrimary} />
            <circle cx='316.60911' cy='538' r='79' fill={baseColorPrimary} />
            <rect x='280.60911' y='600' width='24' height='43' fill={baseColorPrimary} />
            <rect x='328.60911' y='600' width='24' height='43' fill={baseColorPrimary} />
            <ellipse cx='300.60911' cy='643.5' rx='20' ry='7.5' fill={baseColorPrimary} />
            <ellipse cx='348.60911' cy='642.5' rx='20' ry='7.5' fill={baseColorPrimary} />
            <circle cx='318.60911' cy='518' r='27' fill='#fff' />
            <circle cx='318.60911' cy='518' r='9' fill={colorSecondary} />
            <path
...
ErrorImage.defaultProps = {
    height: 300,
    width: 500,
    baseColorPrimary: '#6973a5',
    baseColorSecondary: '#f2f2f2',
    colorPrimary: '#a8b2e6',
    colorSecondary: '#22253f',
};
